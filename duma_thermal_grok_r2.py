#!/usr/bin/env python3
"""THERMAL-AUDIT-001 Round 2 — Grok"""
import re
...
OUT = Path.home()/'Documents/NEVA/audit_responses/THERMAL-001-R2-GROK.md'
...
with sync_playwright() as pw:
    ...
    OUT.write_text(f'# Grok — THERMAL-001-R2\nДата: {datetime.now()}\n\n{text}')
    print(f'Saved: {OUT}')
    p.close()
