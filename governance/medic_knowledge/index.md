...
# Версия: 5.0 | Дата: 2026-06-15 | Архитектор: Claude
...
|---|---|---|---|
| medic_self.md | Medic самодиагностика | ВСЕ (читать первым) | 1.0 |
| incident_log.md | Журнал инцидентов | ВСЕ (читать вторым) | 1.0 |
| auditor.md | Auditor Daemon v1.0 Т6 | auditor_log_stale, ai_providers_all_down | 2.0 |
...
| neva_medic.md | Medic сам себя | medic_not_running, medic_ai_all_fail | 1.0 |
...
| 2026-06-15 | 3.0 | incident_log.md, Вариант Б активен |
| 2026-06-15 | 4.0 | mcp_server_net.md v2.0: баг sys.path, 6 шагов |
| 2026-06-15 | 5.0 | +control_center.md, +neva_medic.md, +neva_server.md. Полное покрытие всех 11 программ |
